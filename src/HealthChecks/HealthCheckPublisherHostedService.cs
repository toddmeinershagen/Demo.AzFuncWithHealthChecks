...
namespace Demo.AzFuncWithHealthChecks.HealthChecks
{
    ...
    internal sealed class HealthCheckPublisherHostedService : IHostedService
    {
        ...
        public Task StartAsync(CancellationToken cancellationToken = default)
        {
            ...
            _timer = NonCapturingTimer.Create(Timer_Tick, null, dueTime: _options.Value.Delay,
        ...
        private async Task RunPublisherAsync(IHealthCheckPublisher publisher, HealthReport report,
        ...
        private static class Logger
        {
            ...
            private static readonly Action<ILogger, IHealthCheckPublisher, double, Exception?>
                _healthCheckPublisherError = LoggerMessage.Define<IHealthCheckPublisher, double>(
                    LogLevel.Error,
            ...
            private static readonly Action<ILogger, IHealthCheckPublisher, double, Exception?>
                _healthCheckPublisherTimeout = LoggerMessage.Define<IHealthCheckPublisher, double>(
                    LogLevel.Error,
            ...
            public static void HealthCheckPublisherProcessingEnd(ILogger logger, TimeSpan duration,
            ...
            public static void HealthCheckPublisherEnd(ILogger logger, IHealthCheckPublisher publisher,
                TimeSpan duration)
            {
                _healthCheckPublisherEnd(logger, publisher, duration.TotalMilliseconds, null);
            }

            public static void HealthCheckPublisherError(ILogger logger, IHealthCheckPublisher publisher,
                TimeSpan duration, Exception exception)
            {
                _healthCheckPublisherError(logger, publisher, duration.TotalMilliseconds, exception);
            }

            public static void HealthCheckPublisherTimeout(ILogger logger, IHealthCheckPublisher publisher,
                TimeSpan duration)
            {
